...
module.exports = {
    register: async( req, res ) => {
        ...
        console.log({takenUsername}) //wrapping in curlies wil list it as an object with that literal property name and value equal to the value of the variable entered.
        if(takenUsername !== 0) {
